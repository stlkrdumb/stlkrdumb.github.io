                ...
                <main className="relative z-10 mx-auto max-w-5xl px-6 h-full flex items-center justify-center">
                  <section className="flex flex-col items-center text-center animate-fade-in-up w-full">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4">
                      <button onClick={() => fullpageApi.moveTo('contact')} className="h-12 px-8 rounded-full border border-white hover:bg-white/10 text-white transition-all duration-300 shadow-lg backdrop-blur-sm">
                        Follow Me on X
                      </button>
                    </div>
                  </section>
